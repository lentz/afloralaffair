...
{return IWCreatePhotocast("http://www.afloralaffairkc.com/A_Floral_Affair_-_Kansas_City/Portfolio/Pages/Combination_files/rss.xml",false);}
...
loadMozillaCSS('Combination_files/CombinationMoz.css')
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');NotificationCenter.addObserver(null,relayoutMediaGrid_id2,'RangeChanged','id2')
adjustLineHeightIfTooBig('id3');adjustFontSizeIfTooBig('id3');fixAllIEPNGs('../../Media/transparent.gif');IMpreload('Combination_files','shapeimage_2','0');IMpreload('Combination_files','shapeimage_3','0');IMpreload('Combination_files','shapeimage_4','0');IMpreload('Combination_files','shapeimage_5','0');Widget.onload();initializeMediaStream_id2()
